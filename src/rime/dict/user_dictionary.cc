...
size_t UserDictionary::LookupWords(UserDictEntryIterator *result,
	...
	if (input.length() == 1 && boost::regex_match(name_, boost::regex("^sb[fk][mxd]|sb[fkhz][js]|sbjm|sbdp|sbpy|sbzr|sbsp|sbxh$"))) {
		for (int i = 0; i < 7; i++)
			std::strcpy(words[i], "");
	}
        ...
        } else if (boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]ms|sb[fk]s|sb[hz]s$"))) {
            if (len < 4) {
                accessor = db_->Query(input);
            } else if (prefixed) {
        ...
        while (accessor->GetNextRecord(&key, &value)) {
            ...
            if (!is_exact_match && prefixed && len > 8 &&
                ...
                if (r1 == r2) {
                    ...
                    continue;
                       ...
                       boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]ms|sb[fk]s|sb[hz]s$"))) {
                string r1 = (len == 10 && boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]s|sb[hz]s$")) &&
                             !single_selection_) ? input.substr(9, 0) : input.substr(9, len - 9);
                string r2 = (len == 10 && boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]s|sb[hz]s$")) &&
                ...
                if (r1 == r2) {
                    ...
                    continue;
                       ...
                       boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]ms|sb[fk]s|sb[hz]s$"))) {
                string r1 = (len == 5 && boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]s|sb[hz]s$")) &&
                             !single_selection_) ? input.substr(4, 0) : input.substr(4, len - 4);
                string r2 = (len == 5 && boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sb[fk]s|sb[hz]s$")) &&
            ...
            if (boost::regex_match(name_, boost::regex("^sbjm|sbdp|sb[fkhz]j|sb[fk]mk|sb[fk]x$")) &&
                ...
                continue;
                                          ...
                                          boost::regex("^sbjm|sb[fkhz]j|sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m|sbdp|sb[fk]m[ks]|sb[fk][sx]|sb[hz]s$")) &&
                ...
                } else if (boost::regex_match(name_, boost::regex("^sbjm|sbdp|sb[fkhz]j|sb[fk]s|sb[hz]s|sbxh|sbpy|sbzr|sbsp|sbjk|sbkp|sb[fk]m$")) &&
                           !single_selection_) {
                    int i = 0;
                    int j = (len == 5) ? 4 : 9;
                    switch (input[j]) {
        ...
        if (boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjm|sbdp|sbjk|sbkp|sb[fkhz]j|sb[fk]m|sb[fk]s|sb[hz]s$")) && prefixed &&
            ...
            result->SetIndex(0);
        } else if (boost::regex_match(name_, boost::regex("^sbxh|sbpy|sbzr|sbsp|sbjm|sbjk|sbkp|sbdp|sb[fkhz]j|sb[fk]m|sb[fk]s|sb[hz]s$")) && len == 4 &&
            ...
            result->SetIndex(0);
        } else if (boost::regex_match(name_, boost::regex("^sb[fk]x$")) && len == 5 && result->size() > 0 &&
                   !single_selection_) {
            int i = 1;
            while (i < 7) {
                auto en = result->Peek();
